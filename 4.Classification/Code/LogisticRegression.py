...
def LogisticRegression_re(_lambda):
    np.random.seed(0)
...
def LogisticRegression(norm=True):
    np.random.seed(0)
    X_train_fpath = './data/X_train'
    Y_train_fpath = './data/Y_train'
    X_test_fpath = './data/X_test'
...
def LogisticRegression_best(norm=True):
    np.random.seed(0)
    X_train_fpath = './data/X_train'
    Y_train_fpath = './data/Y_train'
    X_test_fpath = './data/X_test'
